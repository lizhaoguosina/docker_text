...
function GetFormItem($ctag)
{
	...
	{
		$formitem = "";
		$formitem .= "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td width=\"15%\">".$ctag->GetAtt('itemname')."</td><td>";
		$formitem .= GetEditor($fieldname,'',350,'MemberLit','string');
...
function GetFormItemValue($ctag,$fvalue)
{
  ...
  if($ctag->GetAtt("type")=="textdata")
  {
  	if(is_file($GLOBALS['cfg_basedir'].$fvalue)){
		...
		$formitem  = "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td width=\"15%\">".$ctag->GetAtt('itemname')."</td>\r\n";
		$formitem .= "<td>\r\n".GetEditor($fieldname,$okfvalue,350,'MemberLit','string')."</td>\r\n";
		$formitem .= "</tr></table>\r\n";
	...
	{
		$formitem  = "<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td width=\"15%\">".$ctag->GetAtt('itemname')."</td>\r\n";
		$formitem .= "<td>\r\n".GetEditor($fieldname,$fvalue,350,'MemberLit','string')."</td>\r\n";
		$formitem .= "</tr></table>\r\n";
		return $formitem;
	}
	else if($ctag->GetAtt("type")=="multitext")
