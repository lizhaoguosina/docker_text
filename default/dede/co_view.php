...
<form name='form1' action='co_view.php?action=save&aid=<?=$aid?>' method='post'>
  <tr> 
...
for($i=0;$i<=$dtp->Count;$i++)
{
 ...
 ?>
  ...
  <td height="24" align="center" valign="top" bgcolor="#FFFFFF">
	<?=$fname?>
	<input type='hidden' name='noteid_<?=$i?>' value='<?=$fname?>'>
	</td>
    <td bgcolor="#FFFFFF">
	<?
...
$dtp->Clear();
?>
<input type='hidden' name='endid' value='<?=$i?>'>
  <tr bgcolor="#F8FCF1"> 
    <td height="24" colspan="2" align="center">
    	<input name="imageField" type="image" src="img/button_save.gif" class="np" width="60" height="22" border="0">
    	&nbsp;
     <a href="<?=$backurl?>"><img src="img/button_back.gif" class="np" width="60" height="22" border="0"></a>
    </td>
  </tr>
</table>
</form>
