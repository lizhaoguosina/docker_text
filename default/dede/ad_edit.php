	...
	<table width="100%" border="0" cellspacing="4" cellpadding="4">
      ...
      （如果在所选栏目找不到指定标识的广告内容，系统会自动搜索父栏目）
         ...
         <tr> 
            ...
            <td colspan="2"><input name="adname" type="text" id="adname" size="30" value="<?=$row['adname']?>"></td>
          </tr>
          <tr> 
            <td height="25" align="center">时间限制：</td>
            <td colspan="2"><input class="np" name="timeset" type="radio" value="0"<?if($row['timeset']==0) echo " checked"; ?>>
              永不过期 
              <input class="np" type="radio" name="timeset" value="1" <?if($row['timeset']==1) echo " checked"; ?>>
              在设内时间内有效</td>
          </tr>
          <tr> 
