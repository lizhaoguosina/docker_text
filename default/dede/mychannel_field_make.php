...
<table width="100%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#666666">
  <form name="form1">
    ...
    <tr> 
      ...
      <td bgcolor="#FFFFFF"> <input name="itemname" type="text" id="itemname">
        *（发布内容时显示的项名字） </td>
    </tr>
    <tr> 
      ...
      <td width="72%" bgcolor="#FFFFFF" style="table-layout:fixed;word-break:break-all"> 
        ...
        *（英文，不能和archives表字段重复） </td>
    </tr>
    <tr> 
      <td align="center" bgcolor="#FFFFFF">数据类型：</td>
      <td bgcolor="#FFFFFF"> <select name="dtype" id="type" style="width:250">
    ...
    <tr> 
      ...
      <td bgcolor="#FFFFFF"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="30%"> <input name="isnull" type="radio" class="np" value="1" checked>
              是 &nbsp; <input type="radio" name="isnull" class="np" value="0">
              否 </td>
            <td width="18%">是否分页：</td>
            <td width="52%"> <input name="spage" type="radio" class="np" value="split">
              是 &nbsp; <input name="spage" type="radio" class="np" value="no" checked>
              否 </td>
          </tr>
        </table></td>
    </tr>
    <tr> 
      ...
      <td bgcolor="#FFFFFF"> <input name="vdefault" type="text" id="vdefault"> 
      </td>
    </tr>
    <tr> 
      <td align="center" bgcolor="#FFFFFF">最大长度：</td>
      <td bgcolor="#FFFFFF"> <input name="maxlength" type="text" id="maxlength">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF">自定义表单HTML时，表单名必须为“字段名称”，value='@value'，如果定义数据类型为select或radio时，请在此处填写被选择的项目，用“,”分开，如“男,女,人妖”。</td>
    </tr>
    <tr> 
      <td align="center" bgcolor="#FFFFFF"><br>
      </td>
      <td bgcolor="#FFFFFF"><textarea name="vinnertext" cols="45" rows="5" id="vinnertext"></textarea> 
      </td>
    </tr>
    <tr bgcolor="#F9FDF0"> 
